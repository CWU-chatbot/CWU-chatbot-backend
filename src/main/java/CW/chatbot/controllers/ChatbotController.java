...
public class ChatbotController {
    ...
    public ResponseEntity<ChatbotResponseDTO> getResponse(@RequestBody ChatbotRequestDTO request, @RequestHeader("Authorization") String authorizationHeader) {
        ...
        try {
            ...
            String responseContent = chatbotService.getChatbotResponse(request.getFolderId(), request.getContent(), token);
            ...
            return ResponseEntity.internalServerError().body(new ChatbotResponseDTO(HttpStatus.INTERNAL_SERVER_ERROR.value(), "An unexpected error occurred: " + e.getMessage(), null));
        }
    }
}
